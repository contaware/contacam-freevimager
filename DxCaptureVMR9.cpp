							...
							BOOL bMpeg2)
{
	...
	hr = m_pGraph->AddFilter(m_pVmr9, L"Video Mixing Renderer");
	if (FAILED(hr))
	{
    ...
    IVMRFilterConfig* pConfigVMR9;
    hr = m_pVmr9->QueryInterface(IID_IVMRFilterConfig, (void**)&pConfigVMR9);
    if (SUCCEEDED(hr)) 
    {
    ...
    hr = m_pVmr9->QueryInterface(IID_IVMRWindowlessControl, (void**)&m_pWindowlessControlVMR9);
    if (SUCCEEDED(hr)) 
    {
