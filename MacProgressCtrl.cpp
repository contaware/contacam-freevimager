...
BOOL CMacProgressCtrl::IsThemed()
{
...
//-------------------------------------------------------------------
//
COLORREF CMacProgressCtrl::LightenColor(const COLORREF crColor, BYTE byIncreaseVal)
//
// Return Value:	None.
//
...
//
{
	...
	if ((wRed + byIncreaseVal) <= 255)
		wRed += byIncreaseVal;
	if ((wGreen + byIncreaseVal)	<= 255)
		wGreen += byIncreaseVal;
	if ((wBlue + byIncreaseVal) <= 255)
		wBlue += byIncreaseVal;
...
//-------------------------------------------------------------------
//
COLORREF CMacProgressCtrl::DarkenColor(const COLORREF crColor, BYTE byReduceVal)
//
// Return Value:	None.
//
// Parameters	:	crColor - References a COLORREF structure.
