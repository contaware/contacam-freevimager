...
#define WM_THREADSAFE_INVALIDATE_MDICLIENTWND		WM_USER + 101
...
#define ID_TIMER_CAMERAADVANCEDSETTINGSDLG			11
...
protected:
	...
	afx_msg LONG OnThreadSafeInvalidateMDIClientWnd(WPARAM wparam, LPARAM lparam);
#ifdef VIDEODEVICEDOC
