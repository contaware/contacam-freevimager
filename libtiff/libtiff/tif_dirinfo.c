...
exifFieldInfo[] = {
    ...
    { EXIFTAG_SUBJECTDISTANCE,	1, 1,		TIFF_SRATIONAL,	FIELD_CUSTOM, 
      1,	0,	"SubjectDistance" },
    ...
    { EXIFTAG_HUMIDITY,	1, 1,				TIFF_RATIONAL,	FIELD_CUSTOM,
      1,	0,	"Humidity" },
    { EXIFTAG_PRESSURE,	1, 1,				TIFF_RATIONAL,	FIELD_CUSTOM,
      1,	0,	"Pressure" },
    { EXIFTAG_WATERDEPTH,	1, 1,			TIFF_SRATIONAL,	FIELD_CUSTOM,
      1,	0,	"WaterDepth" },
