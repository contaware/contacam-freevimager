// MovDetAnimGifConfigurationDlg.cpp : implementation file
//
...
void CMovDetAnimGifConfigurationDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CMovDetAnimGifConfigurationDlg)
...
BEGIN_MESSAGE_MAP(CMovDetAnimGifConfigurationDlg, CDialog)
	//{{AFX_MSG_MAP(CMovDetAnimGifConfigurationDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CMovDetAnimGifConfigurationDlg message handlers

BOOL CMovDetAnimGifConfigurationDlg::OnInitDialog() 
{
...
void CMovDetAnimGifConfigurationDlg::OnChangeEditPercentHeight() 
{
...
void CMovDetAnimGifConfigurationDlg::OnChangeEditPercentWidth() 
{
	if (m_bDlgInitialized)
	{
		if (UpdateData(TRUE))
...
void CMovDetAnimGifConfigurationDlg::OnChangeEditPixelsHeight() 
{
	if (m_bDlgInitialized)
	{
		if (UpdateData(TRUE))
...
void CMovDetAnimGifConfigurationDlg::OnChangeEditPixelsWidth() 
{
	if (m_bDlgInitialized)
	{
		if (UpdateData(TRUE))
...
void CMovDetAnimGifConfigurationDlg::OnOK() 
{
