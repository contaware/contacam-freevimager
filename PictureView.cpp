...
void CPictureView::UpdateCropStatusText()
{
	...
	if (pDoc->m_bCrop)
	{
		...
		{
			sCropRect.Format(	ML_STRING(1234, "W=%dpx , H=%dpx , W/H=%0.2f (l=%d,t=%d,r=%d,b=%d) ") +
		...
		else if (((CUImagerApp*)::AfxGetApp())->m_nCoordinateUnit == COORDINATES_INCH)
		{
			...
			if (nYDpi <= 0)
				nYDpi = DEFAULT_DPI;
			sCropRect.Format(	ML_STRING(1236, "W=%0.2fin , H=%0.2fin , W/H=%0.2f (l=%0.2f,t=%0.2f,r=%0.2f,b=%0.2f) ") +
								ML_STRING(1235, "*** CTRL Lock Ratio, ENTER Apply, ESC Cancel ***"),
		...
		else
		{
			...
			if (nYDpi <= 0)
				nYDpi = DEFAULT_DPI;
			sCropRect.Format(	ML_STRING(1237, "W=%0.2fcm , H=%0.2fcm , W/H=%0.2f (l=%0.2f,t=%0.2f,r=%0.2f,b=%0.2f) ") +
								ML_STRING(1235, "*** CTRL Lock Ratio, ENTER Apply, ESC Cancel ***"),
