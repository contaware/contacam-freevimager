...
BOOL AFXAPI CDiscFormatDataEvent::ConnectionAdvise(LPUNKNOWN pUnkSrc, REFIID iid,
...
BOOL AFXAPI CDiscFormatDataEvent::ConnectionUnadvise(LPUNKNOWN pUnkSrc, REFIID iid,
...
bool CDiscFormatDataEvent::ConnectDiscFormatData(CDiscFormatData* pDiscFormatData)
{
	...
	BOOL bRet = ConnectionAdvise(m_pUnkSrc, IID_DDiscFormat2DataEvents, m_pUnkSink,
		TRUE, &m_dwCookie);
	if (bRet)
	{
		return true;
