...
define("VIEWSNAPSHOTSFOR","Visualizza snapshot(s) per");
define("VIEWFILESFOR","Visualizza file(s) per");
define("SELECT","seleziona");
define("IMAGERELOADIN","L'immagine verrà aggiornata tra");
define("SECONDS","secondi");
define("RELOAD","Ricaricare");
define("HOME","Seleziona Telecamera");
define("PRINTCOMMAND","Stampa");