...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-cflags=-mstackrealign --arch=x86 --cpu=i686 --enable-gpl --enable-version3 --enable-hardcoded-tables --enable-libmp3lame --enable-libx264 --disable-amd3dnowext --disable-sse2 --disable-sse3 --disable-ssse3 --disable-sse4 --disable-sse42 --disable-avx --disable-xop --disable-fma3 --disable-fma4 --disable-avx2 --disable-zlib --disable-bzlib --disable-iconv --disable-debug --disable-doc --enable-network --disable-filters --enable-filter=aresample --disable-decoders --enable-decoder=aac --enable-decoder=adpcm_g722 --enable-decoder=adpcm_g726 --enable-decoder=adpcm_g726le --enable-decoder=adpcm_ima_wav --enable-decoder=g723_1 --enable-decoder=g729 --enable-decoder=h263 --enable-decoder=h264 --enable-decoder=mjpeg --enable-decoder=mp2 --enable-decoder=mp3 --enable-decoder=mpeg4 --enable-decoder=pcm_alaw --enable-decoder=pcm_mulaw --enable-decoder=pcm_s16be --enable-decoder=pcm_s16le --enable-decoder=pcm_u8 --enable-decoder=qcelp --disable-encoders --enable-encoder=aac --enable-encoder=adpcm_ima_wav --enable-encoder=h263 --enable-encoder=h263p --enable-encoder=libmp3lame --enable-encoder=libx264 --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=pcm_s16be --enable-encoder=pcm_s16le --enable-encoder=pcm_u8 --enable-encoder=rawvideo --disable-parsers --enable-parser=aac --enable-parser=mpegaudio --enable-parser=mjpeg --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=h263 --enable-parser=h264 --disable-demuxers --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=rtsp --disable-muxers --enable-muxer=avi --enable-muxer=mov --enable-muxer=mp4 --disable-bsfs --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=http --enable-protocol=rtp --enable-protocol=tcp --enable-protocol=udp
prefix=/usr/local
...
CFLAGS=  -mstackrealign -march=i686 -std=c99 -fomit-frame-pointer -Id:/mingw/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -mstackrealign -march=i686
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--large-address-aware -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-lws2_32 -Ld:/mingw/lib -lx264 -lmp3lame -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
libavfilter_VERSION=5.7.101
libavfilter_VERSION_MAJOR=5
libavfilter_VERSION_MINOR=7
libavformat_VERSION=56.18.101
...
libavutil_VERSION=54.16.100
libavutil_VERSION_MAJOR=54
libavutil_VERSION_MINOR=16
