...
#define DEFAULT_SNAPSHOT_HISTORY_FRAMERATE	16			// fps
...
#define PHPCONFIG_MIN_THUMSPERPAGE			4
#define PHPCONFIG_MAX_THUMSPERPAGE			32
#define PHPCONFIG_DEFAULT_THUMSPERPAGE		28
