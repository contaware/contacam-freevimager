...
public:
	...
	volatile float m_fVideoRecQuality;					// 2.0f best quality, 31.0f worst quality, for H.264 clamped to [VIDEO_QUALITY_LOSSLESS, VIDEO_QUALITY_LOW]
	...
	volatile int m_nDetectionLevel;						// 10 = Min Sensitivity, 20, 30, 40, 50, 60, 70, 80, 90 = Max Sensitivity, 100 = Continuous Recording
