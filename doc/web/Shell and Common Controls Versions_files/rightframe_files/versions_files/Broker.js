...
function SiteRecruit_PageConfigurationBroker()
{
    ...
    function PageConfigurationBroker_initializeMapping()
    {
        ...
        var x = this.priorities;
                ...
                p[0] = '/library/svy/SiteRecruit_PageConfiguration_2943mt32_Email_DDS-3089mt-2944mt1.js';
                x[0] = 0;
                                        
             
                            // http://msdn.microsoft.com/chats/chatroom.aspx
                u[1] = '//[\\w\\.-]+/chats/chatroom\\.aspx$';
                p[1] = '/library/svy/SiteRecruit_PageConfiguration_3056mt-2943mt32-3089mt-2944mt1.js';
                x[1] = 1;
                                        
             
                            // http://msdn.microsoft.com/practices...
                u[2] = '//[\\w\\.-]+/practices(/|$)';
                p[2] = '/library/svy/SiteRecruit_PageConfiguration_2692mt-2943mt32-3089mt-2944mt1.js';
                x[2] = 1;
                                        
             
                            // http://msdn.microsoft.com/subscriptions/account
                u[3] = '//[\\w\\.-]+/subscriptions/account';
                p[3] = '/library/svy/SiteRecruit_PageConfiguration_2641mt-blank.js';
                x[3] = 1;
